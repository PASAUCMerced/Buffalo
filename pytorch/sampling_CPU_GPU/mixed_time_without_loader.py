...
def train(args, device, g, dataset, model):
    ...
    for epoch in range(args.epochs):
        ...
        for it, (input_nodes, output_nodes, blocks) in enumerate(train_dataloader):
            print('step ', it)
            print('num of output nodes ', len(output_nodes))
            ...
            train_time_wo_loader += after_opt_step - after_dataloader_t
        ...
        if epoch >= args.log_indent:
                ...
                without_loader_time_list.append(train_time_wo_loader)
                print('train_time_wo_loader ', train_time_wo_loader)
        print()
    ...
    print('mean exclude dataloader time/epoch {}'.format(mean(without_loader_time_list)))
