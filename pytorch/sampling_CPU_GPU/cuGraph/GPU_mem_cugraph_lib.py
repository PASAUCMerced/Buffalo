...
def train(args, device, g, dataset, model):
    ...
    # del g
    # see_memory_usage("----------------------------------------after delete graph")
    
    # g=g.to('cpu')
    # see_memory_usage("----------------------------------------after graph to cpu")
    
    gc.collect()
    see_memory_usage("----------------------------------------after garbage collection")
    ...
    #                               use_uva=use_uva)
    train_dataloader = DataLoader(cugraph_g, train_idx, sampler, device=device,
                                  batch_size=full_batch_size, shuffle=True,
                                  drop_last=False, num_workers=0,
                                  use_uva=use_uva)
